...
def get_curated_iran_events() -> List[dict]:
    ...
    return [
        ...
        {"date": "2026-03-18", "title": "South Pars Gas Field Struck; World's Largest Gas Reserve Hit", "type": "military", "description": "Iran's offshore South Pars gas field struck — world's largest natural gas reserve shared with Qatar. Qatar blames Israel. IRGC naval officer warns oil facilities 'associated with America.' Iran rejects ceasefire; Hormuz transit effectively halted.", "severity": 5, "fatalities": 0, "lat": 27.5000, "lon": 52.0000, "location": "South Pars, Persian Gulf"},
    ]

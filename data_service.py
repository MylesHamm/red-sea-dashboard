...
def get_curated_iran_events() -> List[dict]:
    ...
    return [
        ...
        {"date": "2026-03-05", "title": "Brent Surges to $85.41; Iran Fires 500+ Missiles, 2000 Drones", "type": "military", "description": "Brent at $85.41 (+4.93%, ~21% weekly). Insurance withdrawn for Hormuz transit. Iran has fired 500+ missiles and 2,000 drones. NATO intercepts missile over Turkey.", "severity": 5, "fatalities": 150, "lat": 35.6892, "lon": 51.3890, "location": "Tehran, Iran"},
